...
// Route::get('/view-file/{id}',  App\Http\Controllers\UploadDocController::class, 'viewFile');
    ...
    Route::post('search-upload-doc', [UploadDocController::class,'filterUploads']);

     Route::apiResource('companies', App\Http\Controllers\CompanyController::class);

    Route::apiResource('primary-folders', App\Http\Controllers\PrimaryFolderController::class);

    Route::apiResource('subfolders', App\Http\Controllers\SubfolderController::class);

    Route::apiResource('years', App\Http\Controllers\YearController::class);

    Route::apiResource('upload-docs', UploadDocController::class);

    Route::apiResource('files', App\Http\Controllers\FileUploadController::class);
    
Route::post('/upload-file', [FileUploadController::class, 'upload']);

// File Download Route
Route::get('/download-file/{fileName}', [FileUploadController::class, 'download']);

    Route::apiResource('filetypes', App\Http\Controllers\FileTypeController::class);

    Route::apiResource('filestatuses', App\Http\Controllers\FileStatusController::class);

Route::get('/primary-folders-companies', [UploadDocController::class, 'getPrimaryFolders']);
    
Route::get('/subfolders-companies', [UploadDocController::class, 'getSubfolders']);

Route::get('pending-upload-docs', [App\Http\Controllers\UploadDocController::class,'pending']);
Route::post('approve-upload-docs', [App\Http\Controllers\UploadDocController::class,'approve']);

Route::post('share-upload-doc', [UploadDocController::class,'shareDocument']);

Route::apiResource('audit-trails', AuditTrailController::class)->only(['index', 'show']);

    // Route::apiResource('get-new-files', App\Http\Controllers\HouseController::class);
// In routes/api.php
// Route::get('upload-docs/{id}', [UploadDocController::class, 'show']);
