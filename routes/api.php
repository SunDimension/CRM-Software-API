...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // In routes/api.php
    Route::get('/genders', [GenderController::class, 'index'])->withoutMiddleware(['auth:sanctum', 'auth']);
    Route::get('/marital-statuses', [MaritalStatusController::class, 'index'])->withoutMiddleware(['auth:sanctum', 'auth']);
    Route::get('/countries', [CountryController::class, 'index'])->withoutMiddleware(['auth:sanctum', 'auth']);
